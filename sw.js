const CACHE_NAME = 'pcp-directives-v114';
...
const ASSETS = [
  ...
  BASE + '/assets/newborn-flowchart-full.png',
  BASE + '/assets/newborn-flowchart-thumb.png',
  BASE + '/assets/trauma-arrest-flowchart-full.png',
  ...
  BASE + '/assets/cpr-guidelines-full.png',
  ...
  BASE + '/assets/field-trauma-triage-flowchart-full.png',
  BASE + '/assets/field-trauma-triage-flowchart-thumb.png',
  BASE + '/assets/spinal-motion-restriction-prompt-card-full.png',
